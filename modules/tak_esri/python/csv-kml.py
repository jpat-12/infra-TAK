...
if __name__ == '__main__':
    csv_file_path = '/opt/TAK-Esri/survey.csv'
    output_file_path = '/var/www/html/survey123.kml'
    while True:
        try:
            parse_csv_and_create_kml(csv_file_path, output_file_path)
            print('Parsed CSV and updated survey123.kml')
