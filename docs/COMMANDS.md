...
python3 - <<'PY'
import re, sys
tag = "v0.4.1-alpha"  # change each release
want = tag.lstrip("v")
...
PY
git commit -m "v0.4.1-alpha"
git push origin main
git tag v0.4.1-alpha && git push origin v0.4.1-alpha
git checkout dev
```
