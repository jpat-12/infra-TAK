...
<div class="main">
  ...
  <div class="card"><div class="card-title">Database maintenance (CoT)</div>
    ...
    <p style="font-size:12px;color:var(--text-dim);margin-bottom:14px">CoT database size: <span id="gd-cot-db-size">—</span> <button type="button" onclick="gdRefreshCotSize()" class="btn btn-ghost" style="margin-left:8px;padding:4px 12px;font-size:12px">Refresh</button></p>
    <div style="display:flex;flex-wrap:wrap;gap:10px;align-items:center">
      ...
      <button type="button" id="gd-vacuum-full-btn" onclick="gdRunVacuum(true)" class="btn btn-ghost" style="color:var(--yellow);border-color:var(--yellow)" title="Locks tables — use during maintenance window">VACUUM FULL</button>
    </div>
    <p style="font-size:11px;color:var(--text-dim);margin-top:10px;margin-bottom:0"><strong>VACUUM ANALYZE</strong> — Reclaims space from deleted rows. Safe while TAK is running. &nbsp; <strong>VACUUM FULL</strong> — Locks tables; run during a maintenance window.</p>
