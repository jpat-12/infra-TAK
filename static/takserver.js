...
function uploadFile(file){
    ...
    xhr.onload=()=>{
        ...
        if(xhr.status===200){
            ...
            function reject(msg,fn){bar.style.background='var(--red)';pc.style.color='var(--red)';pc.textContent=msg;if(fn){fetch('/api/upload/takserver/delete',{method:'POST',headers:{'Content-Type':'application/json'},body:JSON.stringify({filename:fn})}).catch(function(){})}}
            var added=0;
