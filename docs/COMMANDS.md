...
python3 - <<'PY'
import re, sys
tag = "v0.4.4-alpha"  # change each release
want = tag.lstrip("v")
...
PY
git commit -m "v0.4.4-alpha"
git push origin main
git tag v0.4.4-alpha && git push origin v0.4.4-alpha
git checkout dev
```
